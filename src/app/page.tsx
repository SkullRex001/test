...
export default function Home() {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    try {
      ...
      const response = await axios.post("https://ec2-13-218-171-255.compute-1.amazonaws.com/upload", formData, {
        headers: {
  ...
  try {
    console.log(port)
    const response = await axios.get(`https://ec2-13-218-171-255.compute-1.amazonaws.com/download/${port}`, {
      responseType: "blob"
    });
